...
Original file is located at
    https://colab.research.google.com/drive/1u2uVuAVwMHbJ6N3_e_MSQABmjJWXm-JX
"""
...
document.querySelector('#typehere').onchange = async function() {
    ...
    objDiv.appendChild(paraWithText('User: ' + val));
    objDiv.appendChild(paraWithText('Assist: ' + resp));
